...
.panel-default, .panel-clean {
  .panel-variant(@panel-default-border; @panel-default-text; @panel-default-heading-bg; @panel-default-border);
  .panel-heading, .panel-body, .panel-filters{
    padding: 10px 15px;
  }
...
.panel.panel-dashboard{
  ...
  > .panel-heading{
    ...
    + .panel-body, + .fixed-header + .panel-body{
      padding: 0;
      position: absolute;
      left:0;
      right: 0;
    ...
    + .panel-body, + .fixed-header + .panel-body, + .fixed-header{
      .table{
        h1, h2,h3,h4{
          margin: 15px 0 0;
        }
...
.panel.panel-dashboard > .panel-heading + .fixed-header.datepicker + .panel-body {
  // add margin on top of panel-body when fixed heade table exists for proper scroll bar position
    top: 132px;
}
