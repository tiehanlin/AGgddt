...
.selectize-dropdown {
	...
	[data-selectable], .optgroup-header {
		padding: @selectize-padding-dropdown-item-y (@selectize-padding-dropdown-item-x + 15);
	}
	...
	.active, .ui-select-choices-row:hover {
...
.selectize-control.single .selectize-input {
	...
	&:after {
		...
		margin-top: round(-@selectize-arrow-size / 2 - 2);
		width: 0;
		height: 0;
		border-style: solid;
...
.navbar-form .selectize-control.single .selectize-input:after{
	margin-top: -3px;
	right: 17px;
}
