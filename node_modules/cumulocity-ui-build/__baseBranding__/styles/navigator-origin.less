...
.adjustOnTopLogo(@checkLogo) when not(@checkLogo="") {
   top: @headerHeight + (@navigatorWidth * (@appLogo-height/100));
}
...
.navigatorContent {
  ...
  .link {
    ...
    &.parent {
      font-size: @navigator-font-size * 0.93;
      //line-height: 10px;
      position: relative;
  ...
  .slot {
    ...
    z-index: 0;
    color: white;
    border-top: 1px solid lighten(@navigator-separator-color, 3%);
...
.navigatorContent .children li li > a {
  padding-left: 58px;
}
.navigatorContent .children li li li > a {
  padding-left: 70px;
}
.navigatorContent .children li li li li > a {
  padding-left: 50px;
}
.navigatorContent .children li li li li li > a {
  padding-left: 60px;
}
.navigatorContent .children li li li li li li > a {
  padding-left: 70px;
}
.navigatorContent .children li li li li li li li > a {
  padding-left: 80px;
}
.navigatorContent .children li li li li li li li li > a {
  padding-left: 90px;
}
.navigatorContent .children li li li li li li li li li > a {
  padding-left: 100px;
}
.navigatorContent .children li li li li li li li li li li > a {
  padding-left: 110px;
}
