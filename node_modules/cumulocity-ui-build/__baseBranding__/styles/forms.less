...
// smaller labels and table headers
label, table th{
  &.label-xs, .label-xs{
...
.has-feedback label {
  & ~ .form-control-feedback, & ~ c8y-error-feedback .form-control-feedback {
    right: 10px;
    top: (@line-height-computed + 4); // Height of the `label` and its margin
  }
  &.sr-only ~ .form-control-feedback, &.sr-only ~ c8y-error-feedback .form-control-feedback {
    top:auto;
    bottom: 0;
  }
  + select + c8y-error-feedback .form-control-feedback {
    right: 20px;
  }
  ...
  &.visible-sm{
    ...
    @media(min-width: @screen-sm-min) and (max-width: @screen-sm-max){
      & ~ .form-control-feedback, & ~ c8y-error-feedback .form-control-feedback {
         top: (@line-height-computed + 4)!important; // Height of the `label` and its margin
      }
      &.sr-only ~ .form-control-feedback, &.sr-only ~ c8y-error-feedback .form-control-feedback {
         top: 0;
      }
...
.btn-save-wrapper.changed{
  ...
  //defaults to device management vertical tabs spacing
  left:@navtabs-vertical-width;
