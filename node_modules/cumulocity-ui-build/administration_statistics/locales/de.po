...
msgstr[0] "1 API-Request insgesamt."
msgstr[1] "{{requestCount}} API-Requests insgesamt."

msgid "1 device"
msgid_plural "{{devicesCount}} devices"
msgstr[0] "1 Gerät"
msgstr[1] "{{devicesCount}} Geräte"

msgid "1 device API request"
msgid_plural "{{deviceRequestCount}} device API requests"
msgstr[0] "1 API-Request von einem Gerät."
msgstr[1] "{{deviceRequestCount}} API-Requests von Geräten."

msgid "1 root device"
msgid_plural "{{rootDevicesCount}} root devices"
msgstr[0] "1 Hauptgerät"
msgstr[1] "{{rootDevicesCount}} Hauptgeräte"
...
msgstr "Aktuelle monatliche Benutzung"

msgid "Last month usage"
msgstr "Nutzung im vergangenen Monat"

msgid "Number of devices on {{end}}, including child devices."
msgstr "Anzahl der der Geräte an {{end}}, einschließlich Kindgeräte."

msgid "Number of root devices on {{end}}. Does not include child devices."
msgstr "Anzahl der Hauptgeräte an {{end}}. Beinhaltet keine Kindgeräte."
...
msgstr "Benutzung zwischen {{start}} und {{end}}"

msgid "calculating number of API requests"
msgstr "Berechne die API-Requests"

msgid "calculating number of device API requests"
msgstr "Berechne die API-Requests von Geräten"

msgid "calculating number of devices"
msgstr "Berechne die Anzahl der Geräte"

msgid "calculating number of users"
msgstr "Berechne die Anzahl der Benutzer"

msgid "calculating storage"
msgstr "Speicherverbrauch berechnen"
